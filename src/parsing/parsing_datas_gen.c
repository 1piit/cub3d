...
/*   Updated: 2026/03/27 11:07:26 by pbride           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3d.h"

static void	is_here(int *flag, t_file cubfile)
{
...
static void	extra_data(int *flag, t_file cubfile)
{
	int	i;
	int	j;
...
static void	empty_file(int *flag, t_file cubfile)
{
	if (!cubfile.used_lines)
		*flag = 1;
}

static void	check_extension(int *flag, char *file)
{
	int	i;
